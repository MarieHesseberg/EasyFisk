      ...
      <div className="phone-app">
        {screen === "home" && (
          <Home
            ...
            demoStatus={demoStatus}
            salmonKilled={
              catches.filter((item) => item.species === "Laks" && item.result === "Avlivet").length
            }
          />
        )}{" "}
        {screen === "map" && (
          ...
          <Stats
            ...
            onCatch={(record) => {
              ...
              const savedRecord = {
                ...
                id: `ME-${now}`,
                submittedAt: now,
                late: now - record.caughtAt > 2 * 60 * 60 * 1000,
              };
            ...
            catches={catches}
            activeZone={
              zones.find((item) => item.id === sessionZone)?.name || "Sone 3 · Øyslebø–Laudal"
            }
            requestedCatchTime={requestedCatchTime}
            elapsed={elapsed}
            startTime={startTime}
